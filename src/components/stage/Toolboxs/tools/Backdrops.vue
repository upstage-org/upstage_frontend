    ...
    <template #context>
      ...
      <div v-if="background.id === currentBackground.id" class="field has-addons menu-group px-4 my-2">
        ...
        <p class="control menu-group-item is-fullwidth">
          <input class="slider is-fullwidth is-primary mt-0" step="0.5" min="0" :value="currentBackground.speed"
            @input="changeBackdropSpeed" placeholder="seconds" type="number" />
        </p>
      </div>
...
const backgrounds = computed(() => store.tools.backdrops)
