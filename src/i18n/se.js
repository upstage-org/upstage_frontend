export default {
  ...
  replay_playback: "Uppspelning",
  replay_loop: "Slinga",
  replay_loop_enable: "Slinga uppspelning",
  replay_loop_infinite: "Oändlig",
  replay_loop_count: "Slinga {current} av {max}",
  replay_iterations: "Antal upprepningar",
  ...
  replay_auto_compress_desc: "Ta bort inaktiv tid längre än angivna minuter och/eller sekunder. Ange mellanrum mellan aktiva scener (0 = inget mellanrum).",
  ...
  replay_trim_end: "Slut",
  replay_trim_apply: "Tillämpa trim",
  replay_controls_minimize: "Minimera (Esc för att återställa)",
  replay_controls_show: "Visa kontroller",
  tips: "Tips",
  esc: "ESK",
  warning: "Varning",
  ...
  archive_select_performance: "Välj föreställning",
  archive_compress_gap_label: "Ta bort luckor längre än",
  archive_compress_gap_between_label: "Mellanrum mellan scener",
  archive_compress_minutes: "min",
  archive_compress_seconds: "s",
  archive_overwrite_original: "Skriv över original",
  archive_timeline_full: "Okomprimerat arkiv",
  archive_timeline_compressed: "Komprimerat arkiv",
  archive_open_replay: "Öppna replay",
  archive_open_replay_compressed: "Spela komprimerat arkiv",
  archive_save_name: "Spara komprimerat arkiv",
