export default {
  ...
  trim_replay_title: "Réduire les temps morts",
  trim_replay_help:
    "Crée une nouvelle performance archivée. Les silences plus longs que la limite sont raccourcis pour ne garder que cette durée de pause. L'archive d'origine n'est pas modifiée.",
  trim_replay_new_name: "Nom de la nouvelle performance",
  trim_replay_min_pause_label: "Pause minimale à conserver (secondes)",
  trim_replay_create: "Créer la copie raccourcie",
  trim_replay_success: "Archive raccourcie créée.",
  trim_replay_name_suffix: "(compressé)",
  trim_replay_default_name: "Enregistrement (compressé)",
  trim_replay_name_required: "Indiquez un nom pour la nouvelle archive.",
  trim_replay_pause_positive: "Indiquez un nombre de secondes positif.",
