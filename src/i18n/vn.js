export default {
  ...
  workshop: "XƯỞNG",
  replaying: "TRẢ LỜI",
  replay_playback: "Phát lại",
  replay_loop: "Lặp",
  replay_loop_enable: "Lặp phát lại",
  replay_loop_infinite: "Vô hạn",
  replay_loop_count: "Lặp {current} / {max}",
  replay_iterations: "Số lần lặp",
  replay_jump_prev_event: "Sự kiện trước",
  replay_jump_next_event: "Sự kiện tiếp theo",
  replay_auto_compress: "Tự động nén",
  replay_auto_compress_desc: "Loại bỏ thời gian chờ dài hơn số phút và/hoặc giây đã cho. Đặt khoảng cách giữa các cảnh (0 = không có).",
  ...
  replay_trim: "Cắt",
  replay_trim_start: "Bắt đầu",
  replay_trim_end: "Kết thúc",
  replay_trim_apply: "Áp dụng cắt",
  replay_controls_minimize: "Thu nhỏ (Esc để khôi phục)",
  replay_controls_show: "Hiện điều khiển",
  tips: "Lời khuyên",
  esc: "Thoát",
  warning: "Lưu ý",
  ...
  archive_select_performance: "Chọn buổi biểu diễn",
  archive_compress_gap_label: "Loại bỏ khoảng trống dài hơn",
  archive_compress_gap_between_label: "Khoảng cách giữa các cảnh",
  archive_compress_minutes: "phút",
  archive_compress_seconds: "giây",
  archive_overwrite_original: "Ghi đè bản gốc",
  archive_timeline_full: "Kho lưu trữ chưa nén",
  archive_timeline_compressed: "Kho lưu trữ đã nén",
  archive_open_replay: "Mở phát lại",
  archive_open_replay_compressed: "Phát kho lưu trữ đã nén",
  archive_save_name: "Lưu kho lưu trữ đã nén",
