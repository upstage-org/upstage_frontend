export default {
  ...
  replay_auto_compress_desc: "Remove idle time longer than the given minutes and/or seconds. Set the gap between active scenes (0 = no gap).",
  ...
  archive_compress_gap_between_label: "Gap between scenes",
  archive_compress_minutes: "min",
  archive_compress_seconds: "sec",
  archive_overwrite_original: "Overwrite original performance",
  archive_timeline_full: "Uncompressed Archive",
  archive_timeline_compressed: "Compressed Archive",
  archive_open_replay: "Open replay",
  archive_open_replay_compressed: "Play Compressed Archive",
  archive_save_name: "Save Compressed Archive",
