export default {
  ...
  animation_speed_tooltip:
    "Velocidad de animación: segundos por fotograma. Escriba el número y pulse Intro para iniciar la animación y cerrar este menú.",
  ...
  trim_replay_title: "Reducir tiempos muertos",
  trim_replay_help:
    "Crea una nueva interpretación archivada. Los silencios más largos que el límite se acortan para dejar solo esa pausa en segundos. El archivo original no cambia.",
  trim_replay_new_name: "Nombre de la nueva actuación",
  trim_replay_min_pause_label: "Pausa mínima a conservar (segundos)",
  trim_replay_create: "Crear copia recortada",
  trim_replay_success: "Archivo recortado creado.",
  trim_replay_name_suffix: "(comprimido)",
  trim_replay_default_name: "Grabación (comprimida)",
  trim_replay_name_required: "Introduzca un nombre para el nuevo archivo.",
  trim_replay_pause_positive: "Introduzca un número positivo de segundos.",
  ...
  unmute_locally: "Reactivar sonido localmente",
  loop: {
    on: "Bucle",
    off: "Sin bucle",
  },
