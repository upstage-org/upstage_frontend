export default {
  ...
  trim_replay_title: "Cắt bỏ khoảng nghỉ dài",
  trim_replay_help:
    "Tạo một bản lưu trữ mới. Khoảng im lặng dài hơn giới hạn sẽ được rút ngắn để chỉ còn số giây tạm dừng này. Bản gốc không thay đổi.",
  trim_replay_new_name: "Tên bản hiệu suất mới",
  trim_replay_min_pause_label: "Thời gian nghỉ tối thiểu giữ lại (giây)",
  trim_replay_create: "Tạo bản sao đã cắt",
  trim_replay_success: "Đã tạo bản lưu đã cắt.",
  trim_replay_name_suffix: "(đã nén)",
  trim_replay_default_name: "Bản ghi (đã nén)",
  trim_replay_name_required: "Nhập tên cho bản lưu mới.",
  trim_replay_pause_positive: "Nhập số giây dương.",
