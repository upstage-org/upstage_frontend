export default {
  ...
  trim_replay_title: "Korta inaktiva pauser",
  trim_replay_help:
    "Skapar en ny arkiverad föreställning. Tystnader längre än gränsen kortas så att bara så många sekunders paus finns kvar. Originalet ändras inte.",
  trim_replay_new_name: "Namn på ny föreställning",
  trim_replay_min_pause_label: "Minsta paus att behålla (sekunder)",
  trim_replay_create: "Skapa kortad kopia",
  trim_replay_success: "Kortat arkiv skapat.",
  trim_replay_name_suffix: "(komprimerad)",
  trim_replay_default_name: "Inspelning (komprimerad)",
  trim_replay_name_required: "Ange ett namn för det nya arkivet.",
  trim_replay_pause_positive: "Ange ett positivt antal sekunder.",
